<x-guest-layout>
    <div class="auth-form-wrap">
        <div class="auth-form-heading">
            ...
            <h2 class="auth-form-title">Buat Your Space.</h2>
            <p class="auth-form-desc">Daftar untuk mulai menyimpan ruang tontonan kamu di Jakka Space.</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}" class="auth-form">
            ...
            <div class="auth-form-actions">
                <a href="{{ route('login') }}" class="auth-link-muted">Sudah punya akun?</a>
